...
Route::middleware(['auth', 'tenant', 'locale'])->group(function () {
    ...
    Route::prefix('configuracoes/integracoes')->name('settings.integrations.')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            ...
            Route::put('whatsapp/{instance}/users',                  [IntegrationController::class, 'syncWhatsappInstanceUsers'])->name('whatsapp.users.sync');
            Route::post('whatsapp/{instance}/primary',               [IntegrationController::class, 'setPrimaryWhatsappInstance'])->name('whatsapp.primary');
