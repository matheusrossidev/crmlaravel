...
const TEMPLATES = [
    ...
    (function(){var f=buildLeadFlow('Ola! Bem-vindo a nossa loja.',[{prompt:'O que voce procura?',save_to:'interesse',buttons:['Cortinas','Persianas','Blackout','Orcamento completo']},{prompt:'Qual o tamanho da janela? (largura x altura)',save_to:'medida'},{prompt:'Em qual comodo?',save_to:'comodo',buttons:['Sala','Quarto','Cozinha','Escritorio','Outro']}],'Vamos preparar seu orcamento personalizado!');return{id:'curtains',name:'Cortinas e Persianas',category:'Varejo',desc:'Orcamento: tipo, medida, comodo.',icon:'bi-window',color:'#6366f1',steps:f.steps,variables:f.variables}})(),
