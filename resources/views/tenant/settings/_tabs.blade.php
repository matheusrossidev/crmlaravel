@php
    ...
    if ($isAdmin) {
        $settingsTabs[] = ['route' => 'settings.users',          'match' => ['settings.users*'],             'label' => 'Usuarios'];
        $settingsTabs[] = ['route' => 'settings.custom-fields',  'match' => ['settings.custom-fields*'],     'label' => 'Campos Extras'];
    }

    $settingsTabs[] = ['route' => 'settings.integrations.index', 'match' => ['settings.integrations*'],      'label' => 'Integracoes'];
    ...
    $settingsTabs[] = ['route' => 'settings.automations',        'match' => ['settings.automations*'],        'label' => 'Automacoes'];
    $settingsTabs[] = ['route' => 'settings.billing',            'match' => ['settings.billing*', 'billing.*'], 'label' => 'Cobranca'];
