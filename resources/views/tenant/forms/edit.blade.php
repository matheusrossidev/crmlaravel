        ...
        <div class="fe-settings-col">
            ...
            <div class="fe-pane" data-pane="distribution">
                ...
                <div style="margin-bottom:24px;padding-top:20px;border-top:1px solid #f0f2f7;">
                    ...
                    @php
                        $embedScript = '<script src="' . rtrim(config('app.url'), '/') . '/api/form/' . $form->slug . '.js" data-mode="inline" async><' . '/script>';
                    @endphp
...
function updatePopupSnippet() {
    ...
    const snippet = '<' + 'script src="' + APP_URL + '/api/form/' + FORM_SLUG + '.js" ' + attrs + ' async><' + '/script>';
