        ...
        <div class="m-card-body">
            @if($enabled)
                ...
                <div style="display:flex;gap:12px;flex-wrap:wrap;">
                    <a href="{{ route('master.2fa.backup-codes') }}" class="m-btn m-btn-ghost" style="text-decoration:none;">
            ...
            @else
                ...
                <div style="display:flex;gap:28px;align-items:flex-start;flex-wrap:wrap;">
                    ...
                    <div style="flex:1;min-width:220px;">
                        ...
                        <form method="POST" action="{{ route('master.2fa.confirm') }}">
                            @csrf
                            ...
                            <input type="text"
                                   ...
                                   autofocus
                                   required
                                   style="width:100%;padding:12px 16px;border:2px solid #e8eaf0;border-radius:10px;font-size:20px;font-weight:700;text-align:center;letter-spacing:6px;color:#1a1d23;outline:none;transition:border-color .2s;"
...
<div id="disableModal" style="display:none;position:fixed;inset:0;z-index:10000;background:rgba(15,23,42,.5);align-items:center;justify-content:center;">
    <div style="background:#fff;border-radius:16px;width:100%;max-width:400px;margin:16px;padding:28px;box-shadow:0 24px 64px rgba(0,0,0,.18);">
        ...
        <form method="POST" action="{{ route('master.2fa.disable') }}">
            @csrf
            <input type="password"
                   name="password"
