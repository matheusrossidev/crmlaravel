...
<div style="max-width:520px;margin:0 auto;">
    ...
    <div class="m-card">
        <div class="m-card-header">
            ...
            <a href="{{ route('master.2fa.setup') }}" class="m-btn m-btn-ghost m-btn-sm" style="text-decoration:none;">
        ...
        <div class="m-card-body">
            ...
            @if($codes)
                <div style="background:#f8fafc;border:2px solid #e8eaf0;border-radius:14px;padding:20px;">
                    ...
                    <button onclick="copyCodes()" id="btnCopy" style="width:100%;padding:10px;background:#eff6ff;color:#0085f3;border:1.5px solid #bfdbfe;border-radius:10px;font-size:13px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;transition:all .15s;">
            ...
            <div style="margin-top:24px;padding-top:20px;border-top:1px solid #f0f2f7;">
                ...
                <form method="POST" action="{{ route('master.2fa.regenerate-codes') }}" style="display:flex;gap:10px;align-items:flex-end;">
                    @csrf
                    <input type="password"
                           name="password"
