...
<div class="page-container">
    <div style="margin-bottom:24px;">
        ...
        <p style="font-size:13.5px;color:#677489;margin:0;">Aprenda a vender melhor e conquiste certificações.</p>
    </div>
    ...
    @if($courses->isEmpty())
        <div style="padding:60px;text-align:center;background:#fff;border:1.5px solid #e8eaf0;border-radius:14px;color:#97A3B7;">
            ...
            <p style="font-size:14px;font-weight:600;color:#374151;">Nenhum curso disponível</p>
            <p style="font-size:13px;">Novos cursos serão publicados em breve.</p>
        </div>
    @else
