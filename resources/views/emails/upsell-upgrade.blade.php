  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 16px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06);">
        ...
        <!-- Header -->
        <tr>
          <td style="background:#0085f3;padding:48px 40px 40px;text-align:center;">
            ...
            <div style="color:#bfdbfe;font-size:15px;margin-top:8px;">Conheça o plano {{ $targetPlanName }}</div>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:40px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
              <tr><td align="center">
                <a href="{{ $checkoutUrl }}" style="display:inline-block;background:#0085f3;color:#fff;text-decoration:none;font-weight:700;font-size:15px;padding:14px 40px;border-radius:8px;">
                  {{ $ctaText }}
                </a>
              </td></tr>
            </table>
            ...
            <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:20px;margin-bottom:28px;">
              <p style="font-size:14px;color:#1e40af;font-weight:600;margin:0 0 8px;">Por que fazer upgrade?</p>
              <ul style="font-size:13px;color:#1e3a8a;line-height:1.8;margin:0;padding-left:20px;">
