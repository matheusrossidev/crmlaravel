...
return [
    ...
    'trigger_type_keyword'         => 'Keywords in DM',
    'trigger_type_keyword_desc'    => 'Triggers when lead sends DM with keyword',
    'trigger_type_comment'         => 'Commented on post',
    'trigger_type_comment_desc'    => 'Triggers when someone comments on a post/reel with keyword',
    'trigger_post_label'           => 'Target post',
    'trigger_post_any'             => 'Any post',
    'trigger_post_specific'        => 'Specific post/reel',
    'trigger_reply_comment'        => 'Reply on comment (optional)',
    'trigger_reply_comment_ph'     => 'E.g.: Thanks for your interest! I\'ll send you more info privately 😊',
    'trigger_reply_comment_hint'   => 'If filled, replies publicly on the comment before sending DM.',
    'trigger_load_posts'           => 'Load posts',
    'trigger_load_more'            => 'Load more',
    'trigger_loading'              => 'Loading...',
    'trigger_load_error'           => 'Error loading posts. Check Instagram connection.',
    'trigger_keyword_hint_comment' => 'Words in the comment that trigger the flow. E.g.: want, price, link. Leave empty to trigger on any comment.',
    'trigger_chatbot_hint'         => 'Need a flow with questions, conditions and actions? Use the',
    'trigger_chatbot_link'         => 'Chatbot Builder',
    'trigger_chatbot_suffix'       => 'with the "Commented on post" trigger.',
    'node_start_comment'           => 'When someone comments on a post',

    // ── Button types (Instagram) ────────────────────────────────────
    'btn_type_label'               => 'Button type',
    'btn_type_postback'            => 'Reply (advances flow)',
    'btn_type_weburl'              => 'External link',
    'btn_url_label'                => 'URL',

    // ── Sidebar trigger config ──────────────────────────────────────
    'sidebar_trigger'              => 'Trigger',
    'sidebar_trigger_keyword'      => 'Keywords in DM',
    'sidebar_trigger_comment'      => 'Commented on post',
    'sidebar_post_label'           => 'Post',
    'sidebar_post_any'             => 'Any post',
    'sidebar_post_specific'        => 'Specific post/reel',
    'sidebar_reply_label'          => 'Reply on comment',
    'sidebar_reply_ph'             => 'E.g.: I\'ll send you details privately!',
